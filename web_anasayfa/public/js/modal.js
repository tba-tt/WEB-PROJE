!function(t) {
    ...
    70: function(t, e, n) {
        ...
        jQuery((function(t) {
                function e() {
                    var e = t("[data-drupal-messages='']");
                    if (e.find("div[role='messages']").length > 0) {
                        var n = "info";
                        e.find("div[aria-label='success']").length > 0 ? n = "success" : e.find("div[aria-label='error'], div[aria-label='warning']").length > 0 && (n = "error"),
                            alert(e.html(), n)
                    }
                }
                window.fancybox = t.fancybox,
                    window.alert = function(e) {
                        var n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : "error"
                            , o = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : "Tamam"
                            , i = "m-modal--error"
                            , s = "error-circle.svg"
                            , a = "Hata";
                        switch (n) {
                        ...
                        return t.fancybox.open({
                            src: "<div class='m-modal ".concat(i, '\'>\n                <div class="m-modal__body">\n                    <figure>\n                        <img src="/themes/custom/gyz/img/icons/').concat(s, '">\n                    </figure>\n                    <h4>').concat(a, "</h4>\n                    <p>").concat(e, '</p>\n                </div>\n                <div class="m-modal__foot">\n                    <a class="a-btn a-btn--full a-btn--big" data-fancybox-close="" href="javascript:;">').concat(o, '</a>\n                </div>\n                <a class="a-btn-icon btn-close" data-fancybox-close="" href="javascript:;">\n                    <i class="icon-close"></i>ButtonIcon\n                </a>\n            </div>'),
                            type: "html"
                        })
                    }
                    ,
                    window.confirm = function(e, n) {
                        var o = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : "Tamam"
                            , i = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : "İptal"
                            , s = t('<div style="width: 400px;"><p style="text-align: center; margin-top: 40px;">'.concat(e, '</p>\n        <div class="button-container-confirm" style="margin-top: 25px;">\n            <button class="a-btn a-btn--big modal-button modal-button-exit" data-fancybox-close style=\'padding: 0 50px;\'>').concat(i, "</button>\n            <button class=\"a-btn a-btn--big modal-button modal-button-confirm\" data-fancybox-close style='padding: 0 50px; margin-left: 20px;'>").concat(o, "</button>\n        </div>\n     </div>"));
                        t.fancybox.open(s),
                        "function" == typeof n && (s.find(".modal-button-exit").click(n),
                            s.find(".modal-button-confirm").click(n))
                    }
                    ,
                    window.showMessage = function(e) {
                        var n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : "";
                        t.fancybox.open("<div class='m-modal ".concat(n, '\'>\n                <div class="m-modal__body">\n                    ').concat(e, '\n                </div>\n                <a class="a-btn-icon btn-close" data-fancybox-close="" href="javascript:;">\n                    <i class="icon-close"></i>ButtonIcon\n                </a>\n            </div>'))
                    }
                    ,
                    e(),
                    Drupal.behaviors.showAlertMessages = {
                        attach: function(n, o) {
                            t("[data-big-pipe-placeholder-id]").length || e()
                        }
                    }
            }
        ))
        ...
        !function(t, e, n, o) {
            ...
            if (t.console = t.console || {
                ...
                if (n.fn.fancybox)
                    ...
                    }, r = n(t), c = n(e), l = 0, h = t.requestAnimationFrame || t.webkitRequestAnimationFrame || t.mozRequestAnimationFrame || t.oRequestAnimationFrame || function(e) {
                    ...
                    n.extend(g.prototype, {
                        ...
                        addContent: function(t) {
                            ...
                            n.each(i, (function(t, e) {
                                    ...
                                    n.isPlainObject(e) ? (l = e,
                                        h = e.opts || e) : "object" === n.type(e) && n(e).length ? (h = (i = n(e)).data() || {},
                                    ...
                                    n.fancybox.isMobile && l.opts.mobile && (l.opts = p(l.opts, l.opts.mobile)),
                        ...
                        jumpTo: function(t, e) {
                            ...
                            if (!(u.isDragging || u.isClosing || u.isAnimating && u.firstRun)) {
                                ...
                                !(s = u.current ? u.current.opts.loop : u.opts.loop) && (t < 0 || t >= p))
                                    return !1;
                                if (o = u.firstRun = !Object.keys(u.slides).length,
                                    r = u.current,
                                    u.prevIndex = u.currIndex,
                                    u.prevPos = u.currPos,
                                    a = u.createSlide(t),
                                p > 1 && ((s || a.index < p - 1) && u.createSlide(t + 1),
                                (s || a.index > 0) && u.createSlide(t - 1)),
                                    ...
                                    o)
                                    return a.opts.animationEffect && e && u.$refs.container.css("transition-duration", e + "ms"),
                                ...
                                r.pos !== a.pos && (r.isComplete = !1),
                                    ...
                                    i ? (d = c.left - (r.pos * c.width + r.pos * r.opts.gutter),
                        ...
                        createSlide: function(t) {
                            var e, o;
                            return o = (o = t % this.group.length) < 0 ? this.group.length + o : o,
                            !this.slides[t] && this.group[o] && (e = n('<div class="fancybox-slide"></div>').appendTo(this.$refs.stage),
                        ...
                        scaleToActual: function(t, e, o) {
                            var i, s, a, r, c, l = this, h = l.current, d = h.$content, u = n.fancybox.getTranslate(h.$slide).width, f = n.fancybox.getTranslate(h.$slide).height, p = h.width, g = h.height;
                            l.isAnimating || l.isMoved() || !d || "image" != h.type || !h.isLoaded || h.hasError || (l.isAnimating = !0,
                                n.fancybox.stop(d),
                                t = void 0 === t ? .5 * u : t,
                                e = void 0 === e ? .5 * f : e,
                                (i = n.fancybox.getTranslate(d)).top -= n.fancybox.getTranslate(h.$slide).top,
                                i.left -= n.fancybox.getTranslate(h.$slide).left,
                                r = p / i.width,
                                c = g / i.height,
                                s = .5 * u - .5 * p,
                                a = .5 * f - .5 * g,
                            p > u && ((s = i.left * r - (t * r - t)) > 0 && (s = 0),
                            s < u - p && (s = u - p)),
                        ...
                        getFitPos: function(t) {
                            var e, o, i, s, a = t.$content, r = t.$slide, c = t.width || t.opts.width, l = t.height || t.opts.height, h = {};
                            ...
                            (l *= i) > o - .5 && (l = o),
                                "image" === t.type ? (h.top = Math.floor(.5 * (o - l)) + parseFloat(r.css("paddingTop")),
                                    h.left = Math.floor(.5 * (e - c)) + parseFloat(r.css("paddingLeft"))) : "video" === t.contentType && (l > c / (s = t.opts.width && t.opts.height ? c / l : t.opts.ratio || 16 / 9) ? l = c / s : c > l * s && (c = l * s)),
                                h.width = c,
                                h.height = l,
                                h)
                        },
                        ...
                        updateSlide: function(t, e) {
                            ...
                            o && (i || s || "video" === t.contentType) && !t.hasError && (n.fancybox.stop(o),
                        ...
                        setBigImage: function(t) {
                            ...
                            t.$image = s.one("error", (function() {
                                    ...
                                    t.$ghost || (o.resolveImageSlideSize(t, this.naturalWidth, this.naturalHeight),
                                        o.afterLoad(t)),
                                    o.isClosing || (t.opts.srcset && ((e = t.opts.sizes) && "auto" !== e || (e = (t.width / t.height > 1 && r.width() / r.height() > 1 ? "100" : Math.round(t.width / t.height * 100)) + "vw"),
                        ...
                        revealContent: function(t) {
                            ...
                            "zoom" === e && (t.pos === a.currPos && i && "image" === t.type && !t.hasError && (l = a.getThumbPos(t)) ? c = a.getFitPos(t) : e = "fade"),
                                ...
                                s && (l.opacity = .1,
                                    ...
                                    d || !h || "image" !== t.type || t.hasError || t.$content.hide().fadeIn("fast"),
                        ...
                        getThumbPos: function(t) {
                            ...
                            return !(!l || !function(t) {
                                ...
                                return !(!t || t.ownerDocument !== e) && (n(".fancybox-container").css("pointer-events", "none"),
                                    ...
                                    i)
                            }(l[0])) && (i = n.fancybox.getTranslate(l),
                        ...
                        close: function(t, e) {
                            ...
                            return !d.isClosing && (d.isClosing = !0,
                                ...
                                i && d.$refs.container.removeClass("fancybox-is-open").addClass("fancybox-is-closing").css("transition-duration", i + "ms"),
                                    ...
                                    d.hideControls(!0),
                                    d.updateCursor(),
                                "zoom" !== o || s && i && "image" === u.type && !d.isMoved() && !u.hasError && (l = d.getThumbPos(u)) || (o = "fade"),
                                    ...
                                    "auto" == (r = u.opts.zoomOpacity) && (r = Math.abs(u.width / u.height - l.width / l.height) > .1),
                                    r && (l.opacity = 0),
                                        n.fancybox.setTranslate(s, c),
                                        f(s),
                                        n.fancybox.animate(s, l, i, p),
                                        !0) : (o && i ? n.fancybox.animate(u.$slide.addClass("fancybox-slide--previous").removeClass("fancybox-slide--current"), "fancybox-animated fancybox-fx-" + o, i, p) : !0 === t ? setTimeout(p, i) : p(),
                                        !0)))
                        },
                        cleanUp: function(e) {
                        ...
                        trigger: function(t, e) {
                            var o, i = Array.prototype.slice.call(arguments, 1), s = this, a = e && e.opts ? e : s.current;
                            if (a ? i.unshift(a) : a = s,
                                i.unshift(s),
                            n.isFunction(a.opts[t]) && (o = a.opts[t].apply(a, i)),
                            !1 === o)
                                return o;
                            "afterClose" !== t && s.$refs ? s.$refs.container.trigger(t + ".fb", i) : c.trigger(t + ".fb", i)
                        },
                        updateControls: function() {
                            var t = this.current
                                ...
                                , a = t.opts.caption;
                            t.$slide.trigger("refresh"),
                                a && a.length ? (this.$caption = s,
                                    s.children().eq(0).html(a)) : this.$caption = null,
                            this.hasHiddenControls || this.isIdle || this.showControls(),
                                ...
                                i.find("[data-fancybox-prev]").prop("disabled", !t.opts.loop && o <= 0),
                        ...
                        n.fancybox = {
                            ...
                            getInstance: function(t) {
                                ...
                                return e instanceof g && ("string" === n.type(t) ? e[t].apply(e, o) : "function" === n.type(t) && t.apply(e, o),
                                    e)
                            },
                            open: function(t, e, n) {
                                return new g(t,e,n)
                            ...
                            use3d: (i = e.createElement("div"),
                            t.getComputedStyle && t.getComputedStyle(i) && t.getComputedStyle(i).getPropertyValue("transform") && !(e.documentMode && e.documentMode < 11)),
                        ...
                        c.on("mousedown mouseup focus blur", ".fancybox-button", (function(t) {
                                switch (t.type) {
                                    ...
                                    case "focusin":
                                        ...
                                        n(this).is(s) || n(this).is("[disabled]") || n(this).addClass("fancybox-focus");
                                        break;
                                    case "focusout":
                                        n(".fancybox-button").removeClass("fancybox-focus")
                                }
                        ...
                        a = t.extend(!0, {}, e, s.opts.media),
                            t.each(a, (function(e, o) {
                                    if (c = f.match(o.matcher)) {
                                        ...
                                        return l = t.extend(!0, {}, o.params, s.opts[e], d),
            ...
            function(t, e, n) {
                ...
                var o = t.requestAnimationFrame || t.webkitRequestAnimationFrame || t.mozRequestAnimationFrame || t.oRequestAnimationFrame || function(e) {
                    ...
                    , c = function(e) {
                    for (var n, o, i, s, a, r = !1; n = e.get(0),
                        o = void 0,
                        i = void 0,
                        s = void 0,
                        a = void 0,
                        ...
                        s = ("scroll" === o || "auto" === o) && n.scrollHeight > n.clientHeight,
                        a = ("scroll" === i || "auto" === i) && n.scrollWidth > n.clientWidth,
                ...
                l.prototype.destroy = function() {
                    this.$container.off(".fb.touch"),
                        n(e).off(".fb.touch"),
                    this.requestId && (i(this.requestId),
                        this.requestId = null),
                    ...
                    l.prototype.ontouchstart = function(o) {
                        var i = n(o.target)
                            ...
                            , u = h.$content
                            , f = "touchstart" == o.type;
                        if (f && this.$container.off("mousedown.fb.touch"),
                        (!o.originalEvent || 2 != o.originalEvent.button) && d.length && i.length && !r(i) && !r(i.parent()) && (i.is("img") || !(o.originalEvent.clientX > i[0].clientWidth + i.offset().left))) {
                            if (!h || l.isAnimating || h.$slide.hasClass("fancybox-animated"))
                                return o.stopPropagation(),
                                    void o.preventDefault();
                            this.realPoints = this.startPoints = s(o),
                            this.startPoints.length && (h.touch && o.stopPropagation(),
                                this.startEvent = o,
                                this.canTap = !0,
                                this.$target = i,
                                this.$content = u,
                            ...
                            ((this.opts || this.canPan) && (i.is(this.$stage) || this.$stage.find(i).length) || (i.is(".fancybox-image") && o.preventDefault(),
                            n.fancybox.isMobile && i.parents(".fancybox-caption").length)) && (this.isScrollable = c(i) || c(i.parent()),
                            n.fancybox.isMobile && this.isScrollable || o.preventDefault(),
                            (1 === this.startPoints.length || h.hasError) && (this.canPan ? (n.fancybox.stop(this.$content),
                    ...
                    l.prototype.limitMovement = function() {
                        var t, e, n, o, i, s, a = this.canvasWidth, r = this.canvasHeight, c = this.distanceX, l = this.distanceY, h = this.contentStartPos, d = h.left, u = h.top, f = h.width, p = h.height;
                        return i = f > a ? d + c : d,
                            s = u + l,
                        ...
                        c > 0 && i > t && (i = t - 1 + Math.pow(-t + d + c, .8) || 0),
                        c < 0 && i < n && (i = n + 1 - Math.pow(n - d - c, .8) || 0),
                    ...
                    l.prototype.endSwiping = function(t, e) {
                        ...
                        this.sliderLastPos = null,
                            "y" == t && !e && Math.abs(this.distanceY) > 50 ? (n.fancybox.animate(this.instance.current.$slide, {
                                ...
                                o = this.instance.close(!0, 250)) : a && this.distanceX > 0 ? o = this.instance.previous(300) : a && this.distanceX < 0 && (o = this.instance.next(300)),
                    ...
                    l.prototype.onTap = function(e) {
                        var o, i = this, a = n(e.target), r = i.instance, c = r.current, l = e && s(e) || i.startPoints, h = l[0] ? l[0].x - n(t).scrollLeft() - i.stagePos.left : 0, d = l[0] ? l[0].y - n(t).scrollTop() - i.stagePos.top : 0, u = function(t) {
                            var o = c.opts[t];
                ...
                e.extend(n.prototype, {
                    ...
                    set: function(t) {
                        ...
                        o && (!0 === t || o.opts.loop || n.currIndex < n.group.length - 1) ? this.isActive && "video" !== o.contentType && (this.$progress && e.fancybox.animate(this.$progress.show(), {
                            ...
                            ), o.opts.slideShow.speed)) : (this.stop(),
            ...
            function(t, e) {
                ...
                e.extend(o.prototype, {
                    ...
                    create: function() {
                        ...
                        "x" === this.opts.axis && this.$list.width(parseInt(this.$grid.css("padding-right"), 10) + o.group.length * this.$list.children().eq(0).outerWidth(!0))
                    },
                    focus: function(t) {
                ...
                e.extend(!0, e.fancybox.defaults, {
                    ...
                    e(t).on("click", "[data-fancybox-share]", (function() {
                            ...
                            a && ("function" === e.type(a.opts.share.url) && (t = a.opts.share.url.apply(a, [s, a])),
                                n = a.opts.share.tpl.replace(/\{\{media\}\}/g, "image" === a.type ? encodeURIComponent(a.src) : "").replace(/\{\{url\}\}/g, encodeURIComponent(t)).replace(/\{\{url_raw\}\}/g, (o = t,
                                    i = {
                                        "&": "&amp;",
                                        "<": "&lt;",
                                        ">": "&gt;",
